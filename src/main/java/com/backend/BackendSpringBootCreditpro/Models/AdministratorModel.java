...
@Table(name = "Administrator") // Indicamos el nombre que queremos para la tabla en la bd para que no use el de
                               // la clase
public class AdministratorModel {
    ...
    @Column(name = "apiKeyResend", nullable = true, columnDefinition = "VARCHAR(250)") // Es unico y no nullo
    private String apiKeyResend;
    ...
    public void setApiKeyResend(String apiKeyResend) {
        this.apiKeyResend = apiKeyResend;
    }

    public String getApikeyResend() {
